...
((function() {
 var loadPackage = (function(metadata) {
  ...
  var PACKAGE_NAME = "../../asmjs/bin/ex_platform.data";
  var REMOTE_PACKAGE_BASE = "ex_platform.data";
  ...
  function runWithFS() {
   ...
   function processPackageData(arrayBuffer) {
    ...
    Module["removeRunDependency"]("datafile_../../asmjs/bin/ex_platform.data");
   }
   Module["addRunDependency"]("datafile_../../asmjs/bin/ex_platform.data");
...
function integrateWasmJS() {
 var wasmTextFile = "ex_platform.wast";
 var wasmBinaryFile = "ex_platform.wasm";
 var asmjsCodeFile = "ex_platform.temp.asm.js";
